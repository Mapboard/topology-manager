...
SELECT id, geometry, type, created::timestamp, certainty::numeric, false, map_width::numeric, pixel_width::numeric, 'sqlite' FROM map_digitizer.linework_import
WHERE geometry IS NOT null;

INSERT INTO map_digitizer.polygon (id, geometry, type, created, certainty, source)
SELECT id, ST_Multi(geometry), type, created::timestamp, certainty::numeric, 'sqlite' FROM map_digitizer.polygon_import
WHERE geometry IS NOT null;
