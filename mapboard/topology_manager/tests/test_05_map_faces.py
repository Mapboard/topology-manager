...
class TestMapFaces:
    ...
    def test_create_faces_with_overlapping_lines(self, ctx, db, count_on_each_axis):
    ...
    def test_add_parent_layer(self, ctx, db):
    ...
    def test_erase_and_consolidate_faces(self, ctx, db):
...
def test_change_map_face_type(ctx, db):
